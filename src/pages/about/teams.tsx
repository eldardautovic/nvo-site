    ...
    <section className="h-min p-[5rem_5rem]">
      ...
      <div className="flex justify-center flex-wrap gap-10 pt-20">
        <TeamCard
          ...
          text="IT Tim"
          description="Tim zaduzen za informacijske tehnologije"
        />
        <TeamCard
          icon={<IconHandshake width={64} />}
          text="HR Tim"
          description="Tim zaduzen za ljudske resurse"
        />
        <TeamCard
          icon={<IconFundraising width={64} />}
          text="FR Tim"
          description="Tim zaduzen za raspolaganje novcem"
        />
        <TeamCard
          icon={<IconMegaphone width={64} />}
          text="PR Tim"
          description="Tim zaduzen za odnos sa javnoscu"
        />
        <TeamCard
          icon={<IconDesign width={64} />}
          text="Dizajn Tim"
          description="Tim zaduzen za dizajn"
        />
      </div>
    </section>
  );
